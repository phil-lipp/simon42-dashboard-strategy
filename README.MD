...
| `use_better_thermostat_ui_card` | boolean | `false` | Better Thermostat UI Card statt Kacheln |
| `better_thermostat_card_variant` | `normal` \| `mini` | `normal` | Layout der Better Thermostat UI Card |
